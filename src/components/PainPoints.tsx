        ...
        <section id="pain" className="py-24 bg-white overflow-hidden">
            <div className="container-wide">
                ...
                <motion.div
                    ...
                    className="mt-32"
                >
                    <CardSpotlight className="p-10 md:p-16 bg-brand-dark rounded-modern text-white relative overflow-hidden border-none shadow-2xl">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            <h4 className="text-xl md:text-2xl font-black mb-8 text-brand-yellow uppercase tracking-tight">
                                "EU ACHEI QUE O PROBLEMA ERA O ANÚNCIO OU PÁGINA..."
                            </h4>
                            <div className="space-y-6 text-lg md:text-xl text-gray-300 leading-relaxed font-medium">
                                <p>
                                    Um afiliado que rodava R$5.000 por mês no Google Ads veio até nós achando que o problema era anúncio ou página. Ele já tinha testado 12 variações de anúncio e presell. Já tinha trocado a oferta. Já tinha pausado e reativado campanhas mais vezes do que conseguia contar.
                                </p>
                                <p>
                                    Quando conectou a Ratoeira pela primeira vez, descobriu três coisas em menos de 24 horas: <strong className="text-white">30% das suas conversões nunca tinham sido registradas</strong>. Um concorrente direto estava clicando nos anúncios dele todos os dias. E o anúncio que ele tinha pausado "por não performar" era, na verdade, o melhor da conta.
                                </p>
                                <p className="text-white font-black italic">
                                    O problema nunca tinha sido o anúncio ou a presell. Era que ele não conseguia ver o que estava acontecendo de verdade.
                                </p>
                            </div>
                        </div>
                    </CardSpotlight>
