...
const integrationItems: ChainItem[] = [
    ...
    { id: 27, name: "ClickHunts", icon: Zap, details: "CPA Network", logo: "/assets/click_hunts.png" },
    { id: 28, name: "ShakesPRO", icon: TrendingUp, details: "Affiliate Network", logo: "/assets/shakes_pro.png" },
    { id: 29, name: "ClicksAdv", icon: Activity, details: "Performance Marketing", logo: "/assets/clicksadv.png" },
    ...
    { id: 36, name: "CashFactories", icon: DollarSign, details: "CPA Network", logo: "/assets/cash_factories.svg" },
    { id: 37, name: "Ambalaya", icon: Target, details: "Affiliate Network", logo: "/assets/ambalaya.png" },
    ...
    { id: 43, name: "Gasmobi", icon: Zap, details: "Performance Marketing", logo: "/assets/gas.webp" },
    ...
    { id: 66, name: "AdTech", icon: Zap, details: "Technology Provider" },
    { id: 67, name: "Nutra Hub", icon: Activity, details: "Nutra Solutions" },
    { id: 68, name: "CPA Pro", icon: TrendingUp, details: "Performance Network" },
    { id: 69, name: "Marketers Hub", icon: Search, details: "Training Center" },
    { id: 70, name: "Ads Insider", icon: Shield, details: "Insights App" },
    { id: 71, name: "Traffic Guru", icon: Activity, details: "Media Buying App" },
    { id: 72, name: "Elite Affiliate", icon: Target, details: "Private Network" },
];
