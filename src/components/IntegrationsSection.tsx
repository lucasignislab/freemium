...
const integrationItems: ChainItem[] = [
    ...
    { id: 12, name: "Webvork", icon: Shield, details: "Nutra CPA" },
    { id: 13, name: "TrafficLight", icon: Activity, details: "CPA Network" },
    { id: 14, name: "LemonAd", icon: Zap, details: "Performance Marketing" },
    { id: 15, name: "CartPanda", icon: ShoppingCart, details: "Checkout & E-commerce" },
    { id: 16, name: "SmashLoud", icon: BarChart3, details: "Affiliate Network" },
    { id: 17, name: "LeadBit", icon: Target, details: "Lead Generation" },
    { id: 18, name: "BlitzAds", icon: Zap, details: "CPA Network" },
    { id: 19, name: "Kiwify", icon: CreditCard, details: "Infoprodutos" },
    { id: 20, name: "NutriProfits", icon: Activity, details: "Nutra CPA" },
    { id: 21, name: "ProfitPay", icon: DollarSign, details: "Payment Gateway" },
    { id: 22, name: "LeadRock", icon: Layers, details: "CPA Network" },
    { id: 23, name: "Monetizze", icon: Database, details: "Checkout Robusto" },
    { id: 24, name: "EverAD", icon: Target, details: "CPA Network" },
    { id: 25, name: "Netvork", icon: Globe, details: "Affiliate Network" },
    { id: 26, name: "EverFlow", icon: Share2, details: "Partner Marketing" },
    { id: 27, name: "ClickHunts", icon: Zap, details: "CPA Network" },
    { id: 28, name: "ShakesPRO", icon: TrendingUp, details: "Affiliate Network" },
    { id: 29, name: "ClicksAdv", icon: Activity, details: "Performance Marketing" },
    { id: 30, name: "SellHealth", icon: Activity, details: "Nutra CPA" },
    { id: 31, name: "AffBay", icon: Target, details: "CPA Network" },
    { id: 32, name: "CPAGetti", icon: Layers, details: "Global CPA" },
    { id: 33, name: "MetaCPA", icon: Shield, details: "Lead Generation" },
    { id: 34, name: "Adexico", icon: BarChart3, details: "CPA Network" },
    { id: 35, name: "ClickDealer", icon: Globe, details: "Global Affiliate" },
    { id: 36, name: "CashFactories", icon: DollarSign, details: "CPA Network" },
    { id: 37, name: "Ambalaya", icon: Target, details: "Affiliate Network" },
    { id: 38, name: "Aff1", icon: Zap, details: "Global CPA" },
    { id: 39, name: "HealthTrader", icon: Activity, details: "Nutra CPA" },
    { id: 40, name: "GiantMobi", icon: Smartphone, details: "Mobile CPA" },
    { id: 41, name: "CPAHouse", icon: Layers, details: "Affiliate Network" },
    { id: 42, name: "CPACombo", icon: Target, details: "CPA Network" },
    { id: 43, name: "Gasmobi", icon: Zap, details: "Performance Marketing" },
    { id: 44, name: "Kma", icon: Database, details: "Affiliate Network" },
    { id: 45, name: "ProfitNXT", icon: TrendingUp, details: "CPA Network" },
    { id: 46, name: "SkyLead", icon: Globe, details: "Lead Generation" },
    { id: 47, name: "MoreNiche", icon: Activity, details: "Health & Beauty" },
    { id: 48, name: "Logzz", icon: Package, details: "Logística & Checkout" },
    { id: 49, name: "Maxbounty", icon: DollarSign, details: "Leading CPA Network" },
    { id: 50, name: "SharkPlatform", icon: Shield, details: "Ads Shield" },
    { id: 51, name: "MyLead", icon: Globe, details: "Global Affiliate" },
    { id: 52, name: "PerfectPay", icon: CreditCard, details: "Gateway de Vendas" },
    { id: 53, name: "Orbio", icon: Zap, details: "Performance Marketing" },
    { id: 54, name: "Payt", icon: DollarSign, details: "Checkout de Conversão" },
    { id: 55, name: "LeadReaktor", icon: Target, details: "CPA Network" },
    { id: 56, name: "Ticto", icon: Zap, details: "Plataforma de Vendas" },
    { id: 57, name: "Hebreus", icon: Shield, details: "Gestão & CRM" },
    { id: 58, name: "NutraBank", icon: Database, details: "Financial & CPA" },
];
