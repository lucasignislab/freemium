...
const integrationItems: ChainItem[] = [
    ...
    { id: 73, name: "Hotmart", icon: ShoppingCart, details: "Checkout & Affiliate", logo: "/assets/hotmart.jpg" },
    ...
    { id: 25, name: "Netvork", icon: Globe, details: "Affiliate Network", logo: "/assets/NetvŌrk.png", bgClass: "bg-brand-dark", imgClass: "object-cover rounded-full" },
    ...
    { id: 74, name: "Yampi", icon: ShoppingCart, details: "Checkout & E-commerce", logo: "/assets/yampi.png" },
    { id: 75, name: "Offersify", icon: Zap, details: "Performance Marketing", logo: "/assets/offersify.png" },
    { id: 76, name: "AppMax", icon: CreditCard, details: "Gateway de Pagamento", logo: "/assets/appmax.avif" },
    { id: 77, name: "KeedPay", icon: CreditCard, details: "Gateway de Pagamento", logo: "/assets/keedpay.jpeg" },
    { id: 78, name: "PagTrust", icon: Shield, details: "Gateway de Vendas", logo: "/assets/pagtrust.png" },
    { id: 79, name: "ManyMoney", icon: DollarSign, details: "Plataforma de Vendas", logo: "/assets/manymoney.png" },
    { id: 80, name: "JVZoo", icon: Globe, details: "Affiliate Network", logo: "/assets/jvzoo.png" },
    { id: 82, name: "CPAOMNI", icon: Target, details: "CPA Network", logo: "/assets/CPAOMNI.jpg" },
    { id: 83, name: "MonadLead", icon: Zap, details: "Performance Marketing", logo: "/assets/MonadLead.jpeg" },
    ...
    { id: 84, name: "Kirvano", icon: ShoppingCart, details: "Plataforma de Vendas", logo: "/assets/Kirvano.webp" },
    { id: 57, name: "Hebreus", icon: Shield, details: "Gestão & CRM", logo: "/assets/hebreus.png" },
    { id: 85, name: "Eduzz", icon: TrendingUp, details: "Produtos Digitais", logo: "/assets/Eduzz.png" },
    ...
    { id: 86, name: "VegasV2", icon: Activity, details: "Growth & Scaling" },
    { id: 87, name: "Doppus", icon: DollarSign, details: "Checkout de Conversão", logo: "/assets/Doppus.jpeg" },
    { id: 88, name: "ImperiumPay", icon: CreditCard, details: "Gateway de Pagamento", logo: "/assets/ImperiumPay.png" },
    ...
    { id: 89, name: "Kiwify", icon: ShoppingCart, details: "Infoprodutos & Checkout", logo: "/assets/kiwify.png" },
    { id: 52, name: "PerfectPay", icon: CreditCard, details: "Gateway de Vendas", logo: "/assets/perfectpay.png" },
    { id: 90, name: "Coinzz", icon: Database, details: "Financial & CPA", logo: "/assets/Coinzz.png" },
    { id: 91, name: "DigitalManagerGuru", icon: BarChart3, details: "Marketing Analytics", logo: "/assets/DigitalManagerGuru.webp" },
